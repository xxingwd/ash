...
After dispatching all independent lines, explicitly call wait for every owned group or independent child you started. list/history are inspection, not receipt: idle work with unread=true still requires wait. Do not stop merely because message returned an acceptance receipt.
